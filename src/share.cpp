...
//单红外校准
ShareMemory<SingleIRCalibCtrl>::ptr SingleIRCalibCtrlShareAddress =
    std::make_shared<ShareMemory<SingleIRCalibCtrl>>(0x1145);
...
//图像数据数组
SharedMemoryArray<uint8_t>::ptr ImageDataShareAddress =
    std::make_shared<SharedMemoryArray<uint8_t>>(0x00010000, 640 * 480 * 3);
