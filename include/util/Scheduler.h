...
namespace robot {
    ...
    public:
        ...
        // std::map<CommandGroup::ptr, bool> command_groups;
        // std::map<ICommand::ptr, bool> commands_;
    ...
    public:
        ...
        /**
         * Returns the Scheduler getInstance.
         *
        ...
        void stop();
        void tickle();
        bool schedule(ICommand::ptr command_ptr);
