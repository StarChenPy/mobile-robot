  ...
  public:
    ...
    std::string toString() override {
        try {
            ...
            std::cout << "ConfigVar::toString exception " << e.what() << " convert: " << typeToName<T>() << " to string"
    ...
    bool fromString(const std::string &val) override {
        try {
            ...
            std::cout << "ConfigVar::fromString exception " << e.what() << " convert: string to " << typeToName<T>()
                      << " name=" << m_name << " - " << val << std::endl;
        }
        return false;
    }
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string &name, const T &default_value,
        ...
        if (it != GetDatas().end()) {
            ...
            if (tmp) {
                ...
                std::cout << "Lookup name=" << name << " exists but type not " << typeToName<T>()
                          << " real_type=" << it->second->getTypeName() << " " << it->second->toString() << std::endl;
                return nullptr;
            }
        }
