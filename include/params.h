...
#define LIDAR_CALIB_PID  {0.5, 0.3, 0, 10}
...
// 夹手舵机B
#define CLAMP_LEN_B  (CLAMP_LEN_MAX * CLAMP_SERVO_MIN - CLAMP_LEN_MIN * CLAMP_SERVO_MAX) / (CLAMP_LEN_MAX - CLAMP_LEN_MIN)
...
// 抬手舵机B
#define RAISE_ANGLE_B  (RAISE_ANGLE_MAX * RAISE_SERVO_MIN - RAISE_ANGLE_MIN * RAISE_SERVO_MAX) / (RAISE_ANGLE_MAX - RAISE_ANGLE_MIN)
...
// 抬手舵机B
#define TELESCOPIC_DIS_B  (TELESCOPIC_DIS_MAX * TELESCOPIC_SERVO_MIN - TELESCOPIC_DIS_MIN * TELESCOPIC_SERVO_MAX) / (TELESCOPIC_DIS_MAX - TELESCOPIC_DIS_MIN)
...
// 旋转舵机B
#define ROTATING_ANGLE_B  (ROTATING_ANGLE_MAX * ROTATING_SERVO_MIN - ROTATING_ANGLE_MIN * ROTATING_SERVO_MAX) / (ROTATING_ANGLE_MAX - ROTATING_ANGLE_MIN)
...
//电机位置环
#define LIFTMOTORDISTANCEPIDPARAMS  {0.05, 0.0, 0.01}
#define TURNMOTORDISTANCEPIDPARAMS  {0.05, 0.0, 0.01}
#define LIFTMOTODISTANCELIMITS  {-30, 30}
#define TURNMOTODISTANCELIMITS  {-30, 30}
//误差配置
...
// IR校准角度和距离的PID参数
#define IRDISTANCEPID {1.5, 0.0, 0}
#define IRANGLEPID {0.5, 0.0, 0.0}
#define IRDISTANCEOUTPUTLIMITS  {-20, 20}
#define IRANGLEOUTPUTLIMITS  {-10, 10}

// 单IR校准角度和距离的PID参数
#define SINGLEIRDISTANCEPID {1.5, 0.0, 0}
#define SINGLEIRANGLEPID {1.0, 0.0, 0.0}
#define SINGLEIRDISTANCEOUTPUTLIMITS  {-20, 20}
#define SINGLEIRANGLEOUTPUTLIMITS  {-10, 10}

// US校准角度和距离的PID参数
#define USDISTANCEPID {1.5, 0.0, 0}
#define USANGLEPID {0.5, 0.0, 0.0}
#define USDISTANCEOUTPUTLIMITS  {-20, 20}
#define USANGLEOUTPUTLIMITS  {-10, 10}

// 雷达校准
#define LIDARANGLEPID {1.5, 0.0, 0.1}
#define LIDARDISTANCEPID {1.5, 0.0, 0.1}
#define LIDARANGLEPIDOUTPUTLIMITS {-10,10}
#define LIDARDISTANCEPIDOUTPUTLIMITS {-20,20}
//误差配置
...
// 雷达沿墙行驶
#define ALONGWALLPID {1, 0.0, 0.1}
#define ALONGWALLPIDLIMITS {-5,5}

// 坐标移动pid
#define VXPID {2.5, 1.5, 0, 60}
#define VYPID {2.5, 3.5, 0, 40}
#define VZPID {1.0, 4.0, 0, 180}
// 控制参数
