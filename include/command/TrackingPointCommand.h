...
class TrackingPointCommand : public CommandBase {
 public:
  ...
  TrackingPointCommand(Pose target_pose, double v, double e_dis, double e_phi) : target(target_pose), set_v(v), E_dis(e_dis), E_phi(e_phi)  {}
...
class TrackingXYCommand : public CommandBase {
 public:
  ...
  TrackingXYCommand(Pose target_pose, double v, double e_dis, double e_phi) : target(target_pose), set_v(v), E_dis(e_dis), E_phi(e_phi)  {}
  ~TrackingXYCommand() {}
