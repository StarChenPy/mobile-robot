...
class VisionCtrlCommand : public CommandBase {
 ...
 private:
  ...
  const char *Class_names[18]= {
         "banana","bell pepper","chili pepper","fig","green apple","red apple","green grape","mangosteen","momordica charantia","watermelon","potato","egg","red egg","green egg","green grape","purple grape","yellow grape","lianwuguo"};   //只供打印用，改变这个数组并不会改变输出结果label
